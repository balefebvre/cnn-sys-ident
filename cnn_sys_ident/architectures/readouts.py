    ...
    def __init__(self,
        ...
        with base.tf_session.graph.as_default():
            with tf.compat.v1.variable_scope(scope, reuse=reuse):
                ...
                self.masks = tf.compat.v1.get_variable(
                    'masks',
                ...
                # feature weights
                self.feature_weights = tf.compat.v1.get_variable(
                    'feature_weights',
                ...
                tf.compat.v1.losses.add_loss(self.readout_reg, tf.compat.v1.GraphKeys.REGULARIZATION_LOSSES)
